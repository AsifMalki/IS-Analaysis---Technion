...
<body  class="body">
       <form id="form1" runat="server"> 
        ...
        <nav class="navbar" >
            <ul>
               ...
               <li style="justify-content:right"><a href="#home" style="justify-content:right; font-size:large">מערכת עטרה ליושנה</a></li>
         ...
         <div class="container2">
            ...
            שם משתמש או סיסמא לא תקינים
                ...
                <div>
                 ...
                 <div>
                    <button id="Button1" runat="server" onserverclick="Button1_ServerClick" >דיווח ללא הזדהות</button>
                    </div>
                <div>
    ...
    בנוסף המערכת תכלול ממשק ידידותי למשתמש, אשר מיועד לעודד נגישות לדיווח בשונה מהמצב הקיים. כמו כן המערכת תתממשק למערכת BI שתשמש ככלי למנהלים לגיבוש תמונת מצב עדכנית אודות נתונים נדרשים.
        ...
        <section id="service" >
            <h1>Service</h1>
            <p class="lead">דף זה עוד בבנייה</p>
        </section>
        <section id="contact" >
            <h1>Contact</h1>
            <p class="lead">דף זה עוד בבנייה</p>
